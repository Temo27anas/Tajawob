...
const SuccessDeleteReportFR = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.successdeletereportfr}>
      <Image
        style={styles.successdeletereportfrChild}
        resizeMode="cover"
        source={require("../assets/group-457.png")}
      />
      <Text style={styles.votreRapportA}>
        Votre rapport a été supprimé avec succès
      </Text>
      <TouchableHighlight
...
export default SuccessDeleteReportFR;
