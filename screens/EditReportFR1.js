...
const EditReportFR1 = () => {
  ...
  return (
    <View style={[styles.editreportfr1, styles.iconLayout]}>
      ...
      <View style={styles.title}>
        <Text style={styles.modifierLeRapport}>Modifier Le RaPPORT</Text>
      ...
      <View style={styles.suivantWrapper}>
